...
const Home = () => {
    ...
    <>
      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h1 className="sm">MEUBLEZ VOTRE INTÉRIEUR AVEC STYLE !</h1>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100" src={caroussel2} alt="étagere" />
          <Carousel.Caption>
            <h2 className="sm">MEUBLEZ VOTRE INTÉRIEUR AVEC STYLE !</h2>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
          ...
          {[
            ...
            <Col key={index} md={4} sm={6}>
              <Card>
                ...
                <Card.Body>
                  <Button as={Link} to={`/categorie/${item.name}`} variant="outline-dark btn-custom">{item.name}</Button>
                </Card.Body>
              </Card>
            </Col>
          ))}
      ...
      <Container  className="my-5">
        <Row>
          ...
          <Col md={6}>
            <img src={recVertical} alt="Salon" className="img-fluid rounded shadow w-100" />
          </Col>
          ...
          <Col md={6} className="d-flex flex-column justify-content-between  ">
            ...
            <Row className="mt-3  w-100" >
              <Col xs={6}>
                <img src={rectangle12} alt="Chambre" className="img-fluid rounded shadow w-100" />
              </Col>
              <Col xs={6}>
                <img src={rectangle13} alt="Bureau" className="img-fluid rounded shadow w-100" />
              </Col>
            </Row>
          </Col>
        </Row>
  ...
  <Row className="align-items-center g-4  " >
    <Col md={6} className="d-flex flex-column justify-content-center  rounded p-4 h-100 ">
      <img
        src={inspiration}
      ...
      <div className="p-4 text-center h-100">
        <h3 className="fw-bold">Nom du produit</h3>
        <p className="text-muted">
          Apportez une touche d'élégance naturelle à votre intérieur
          avec une sélection de tables en bois design.
        </p>
        <Button as={Link} to="/product" variant="outline-dark btn-custom">Découvrir</Button>
      </div>
    </Col>
    <Col md={6} className="d-flex flex-column justify-content-center  rounded p-4 h-100 ">
    <img
